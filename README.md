...
­° There are rules for running the api call, *you will lose access and privilages if the rules are not followed!* API's can only be called once every hour for tle's. 
  So please be kind and follow the guidelines.<br/>
